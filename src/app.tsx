...
import { useMetadataBackfill } from "./hooks/data/useMetadataBackfill";
...
function App() {
  ...
  const isDisplayedTrackMusic = useMemo(() => {
    ...
    return activeTrack.uri.startsWith("spotify:track:");
  }, [activeTrack]);
    ...
    <div className={styles.container}>
      ...
      {migrationProgress && (
        <div className={styles.migrationBanner}>
          <p>
            Migrating track data: {migrationProgress.processed} /{" "}
            {migrationProgress.total} tracks
          </p>
          <progress
            value={migrationProgress.processed}
            max={migrationProgress.total}
          />
        </div>
      )}
