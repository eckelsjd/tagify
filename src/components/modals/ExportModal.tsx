...
const ExportModal: React.FC<ExportModalProps> = ({ data, onClose }) => {
  // rekordbox actions
  const rekordboxXmlPath =
    localStorage.getItem("tagify:rekordboxXmlPath") || "";
  ...
  const [tagSortMethod, setTagSortMethod] = useState<
  ...
  const ratedTrackCount = Object.values(data.tracks).filter(
  ...
  const totalTags =
    data.tag_analytics?.total_tags || Object.keys(tagDistribution).length;
  const usedTags =
  ...
  const getSortedTags = () => {
    const filteredTags = Object.entries(tagDistribution).filter(
      ([tagName]) =>
        !tagFilterText ||
        tagName.toLowerCase().includes(tagFilterText.toLowerCase())
    );
      ...
      <div className={styles.modalOverlay} onClick={onClose}>
        <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
          <div className={styles.modalHeader}>
            <h2 className={styles.modalTitle}>rekordbox integration</h2>
            ...
            <div className={styles.exportSection}>
              <div className={styles.primaryActionContainer}>
                ...
                <div className={styles.serverStatusContainer}>
                  <div
                    className={`${styles.serverStatus} ${styles[serverStatus]}`}
                  >
              ...
              <p className={styles.info}>
                <strong>Note:</strong> Generating a rekordbox XML file requires
                the Python server to be running.
                <br />
                {rekordboxXmlPath !== "Not configured" ? (
                  ...
                  <span>
                    Please configure the rekordbox XML path in Settings.
                  </span>
                )}
              </p>
                        ...
                        <div className={styles.rangeBar}>
                          <div
                            ...
                            style={{
                              width: `${Math.max(
                                (count /
                                  Math.max(...Object.values(bpmRanges))) *
                                  100,
                                5
                              )}%`,
                              backgroundColor:
                                count > 0 ? undefined : "transparent",
                            }}
                          ></div>
                        </div>
                      </div>
                        ...
                        <div className={styles.energyBar}>
                          <div
                            ...
                            style={{
                              width: `${Math.max(
                                (count /
                                  Math.max(...energyDistribution.slice(1))) *
                                  100,
                                5
                              )}%`,
                              backgroundColor:
                        ...
                        <div className={styles.ratingBar}>
                          <div
                            ...
                            style={{
                              width: `${Math.max(
                                (count /
                                  Math.max(...ratingDistribution.slice(1))) *
                                  100,
                                5
                              )}%`,
                              backgroundColor:
                  ...
                  <div className={styles.tagDistribution}>
                    ...
                    {sortedTags.length === 0 && (
                      <div className={styles.noResults}>
                        No tags found{" "}
                        {tagFilterText && `matching "${tagFilterText}"`}
                      </div>
                    )}
                  </div>
                  ...
                  {pageCount > 1 && (
                    <div className={styles.pagination}>
                      ...
                      <button
                        ...
                        onClick={() =>
                          setTagsPage(Math.min(pageCount, tagsPage + 1))
                        }
                      >
                        Next
                      </button>
